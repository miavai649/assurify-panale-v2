const packageData = [
  {
    shop: 'de489d-29.myshopify.com',
    service: 'Asking for expert installation',
    status: `Resolved`,
    date: '10/22/2024',
  },
  {
    shop: '45230d.myshopify.com',
    service: 'Asking for expert installation',
    status: `Cancelled`,
    date: '09/26/2024',
  },
          ...
          <tbody>
            {packageData.map((packageItem, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div>
                    <button className="hover:text-primary text-center mx-auto">
                      <svg
